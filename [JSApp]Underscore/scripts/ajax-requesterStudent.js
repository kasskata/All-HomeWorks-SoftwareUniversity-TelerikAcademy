var ajaxRequester = (function () {
    ...
    function makeGetRequest(sessionToken,data, success, error) {
        return makeRequest('GET', baseUrl + 'classes/Student', data, includeToken(sessionToken), success, error);
    }

    function makePostRequest(sessionToken, data, success, error) {
        return makeRequest('POST', baseUrl + 'classes/Student', data, includeToken(sessionToken), success, error);
    }
    ...
    function makeDeleteRequest(id, sessionToken, success, error) {
        return makeRequest('DELETE', baseUrl + 'classes/Student/' + id, null, includeToken(sessionToken), success, error);
    }
