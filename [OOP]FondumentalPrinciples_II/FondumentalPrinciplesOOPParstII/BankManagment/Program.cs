...
namespace BankManagment
{
    ...
    internal class Program
    {
        ...
        {
            Individual stamat = new Individual();
            stamat.InterestRatePerMoth=2;
            Console.WriteLine(stamat.InterestRate(2));
            stamat.allAcconCostumer = new List<Account> {new DepositAcc()};
            stamat.allAcconCostumer[0].InterestRatePerMoth = 2;
            Console.WriteLine(stamat.allAcconCostumer[0].InterestRate(1));
        }
    }
}
