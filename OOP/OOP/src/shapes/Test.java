...
import shapes.spaceShapes.SpaceShapes;
...
public class GeometryTester {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SpaceShapes cuboid = new Cuboid(a, 17, 27, 27);
        Shape sphere = new Sphere(a, 9.25);
        ...
        List<SpaceShapes> shapeList = Arrays.asList(shapes).stream()
                .filter(s -> s instanceof SpaceShapes).map(s -> (SpaceShapes) s)
