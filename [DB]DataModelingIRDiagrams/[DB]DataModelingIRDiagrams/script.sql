...
CREATE TABLE `professors` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_professors_title_idx` (`title_id`),
  ...
  CONSTRAINT `fk_professors_title` FOREIGN KEY (`title_id`) REFERENCES `title` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `studentscourses` (
  ...
  `Courses_id` int(11) NOT NULL,
  KEY `fk_studentsCourses_students1_idx` (`students_id`),
  KEY `fk_studentsCourses_Courses1_idx` (`Courses_id`),
  CONSTRAINT `fk_studentsCourses_Courses1` FOREIGN KEY (`Courses_id`) REFERENCES `courses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_studentsCourses_students1` FOREIGN KEY (`students_id`) REFERENCES `students` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-02-10 23:38:51
